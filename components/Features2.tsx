export default function FeaturesBlocks() {
    return (
      <section className="relative">
        ...
        <div className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-[#333] pointer-events-none mb-10" aria-hidden="true"></div>
        {/* <div className="absolute left-0 right-0 bottom-0 m-auto w-px p-px h-20 bg-gray-200 transform "></div> */}
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4 text-5xl font-bold text-[#333]">Explore the Features</h2>
              <p className="text-xl text-[#333]">We approach the workplace as something that adds to our lives and adds value to world.</p>
            </div>
            ...
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
              ...
              {/* 1st item */}
              <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-2xl">
                <svg className="w-14 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Custamization</h4>
