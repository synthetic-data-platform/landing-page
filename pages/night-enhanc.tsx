...
export default function ImgEnhancement(){
    return (
        <div className="flex mx-auto flex-col items-center justify-center py-2 min-h-screen">
            <Head>
            <title>Night Image Enhancement | imgai</title>
            ...
            <h1 className="mb-4 text-3xl font-extrabold text-gray-900 sm:mt-40 mt-10 md:text-5xl lg:text-6xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r to-purple-600 from-sky-400">Night Image Enhacement</span> <br></br>Free to use.</h1>

                <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Enhance really dark images.</p>
            ...
            <Processing versionID="4328e402cfedafa70ad7cec04412e86ab61832204deccd94108ae5222c9b1ae1" processingText='Night Enhanced'/>
